...
The major changes made were mainly how the classes interacted with each other. I ended up adding new classes and removing some others I originally thought I would implement.
I learnt that this really does take a lot of time, especially if you are considering the most efficient ways to put the program together. Additionally, when dealing with something as complicated as numbers
you tend to run into a lot of errors by the smallest of margins. Additionally, the object-oriented way if designing requires a multitude of components to come together with ease. I do see the benefit,
especially if working within groups, unlike other programming languages, it is clearer to identify/pinpoint exactly what method is causing errors. However, getting those various classes to work together will require
